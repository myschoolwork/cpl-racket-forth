...
; This file contains some rudimentary tests for
; bot `semantics.rkt` and `parser.rkt`
; Each file has its own test suite: `ts1` and `ts2`
...
(test/gui ts1 ts2)
;(run-tests ts2) ; non-graphical test function